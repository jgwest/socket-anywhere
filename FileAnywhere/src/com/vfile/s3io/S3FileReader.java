...
public class S3FileReader extends Reader implements IFileReader {
	InputStreamReader _inner = null;
	S3File _file;
	
	public S3FileReader(S3File file) {
		_file = file;
		_inner = new InputStreamReader(new S3FileInputStream(_file));
	}
