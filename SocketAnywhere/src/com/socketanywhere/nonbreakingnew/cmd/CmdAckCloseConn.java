...
public class CmdAckCloseConn extends CmdAbstractUuidConnId {

	public final static int ID = 14;
	private final static byte[] BYTE_CMD_ID = {0x0, 0x14};

	public CmdAckCloseConn(String nodeUUID, int connId) {
