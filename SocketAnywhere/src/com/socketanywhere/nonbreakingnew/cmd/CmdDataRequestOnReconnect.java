...
public class CmdDataRequestOnReconnect extends CmdAbstract {

	public final static int ID = 8;
	
	private final static byte[] BYTE_CMD_ID = {0x0, 0x08};
	...
	public CmdDataRequestOnReconnect(int firstPacketToRsend) {
		super(ID, BYTE_CMD_ID);
		_fieldFirstPacketToResend = firstPacketToRsend;
	}


	CmdDataRequestOnReconnect() {
		super(ID, BYTE_CMD_ID);
	}
	...
	CmdAbstract instantiateInstance() {
		return new CmdDataRequestOnReconnect();
	}

	@Override
	public String toString() {
		return CmdDataRequestOnReconnect.class.getSimpleName()+" - firstPacketToResend: "+_fieldFirstPacketToResend;
	}
