...
public class SSServerSocketImpl implements IServerSocketTL {
	...
	public SSServerSocketImpl(ISocketFactory socketFactory) throws IOException{
		synchronized(SSSocketImpl.LOCK) {
			_socketFactory = socketFactory;
		}
	}

	public SSServerSocketImpl(TLAddress addr, ISocketFactory socketFactory) throws IOException{
		synchronized(SSSocketImpl.LOCK) {
			_addr = addr;
			_socketFactory = socketFactory;
	...
	public ISocketTL accept() throws IOException {
		ISocketTL result = new SSSocketImpl(_serverSocket.accept());
		return result;
	}
