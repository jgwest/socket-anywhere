...
public class CmdDataMultiplex extends CmdMultiplexAbstract {
	...
	public CmdDataMultiplex(byte[] data, int dataLength, int packetId, String nodeUUID, int connId) {
		_fieldData = data;
	...
	public CmdDataMultiplex() {
	}
	
	@Override
	public byte[] buildCommand() {
		int length = PACKET_ID_HEADER_FIELD_LENGTH + DATA_LENGTH_HEADER_FIELD_LENGTH + _fieldDataLength;
	...
	CmdMultiplexAbstract instantiateInstance() {
		return new CmdDataMultiplex();
	}
		
	@Override
	public String toString() {
		return CmdDataMultiplex.class.getSimpleName() + " - dataLength:"+_fieldDataLength + "  packetId:"+_fieldPacketId + " " +super.toString();
	}
