...
import com.socketanywhere.multiplexingnew.MNOptions;
import com.socketanywhere.multiplexingnew.MNSocketFactory;
...
public class MultiSendReceiveMainMNNB2 {
...
//							e.printStackTrace();
			...
			URSocketFactory nbFactory1 = urf;
			URSocketFactory nbFactory2 = urf;
...
//			MNSocketFactory mnSocketFactory;

//			rFactory1 = MNSocketFactory.createServerSocketFactory(new TLAddress(11080), new TCPSocketFactory());
//			rFactory2 = MNSocketFactory.createClientSocketFactory(new TLAddress("localhost", 11080), new TCPSocketFactory());

			rFactory1 = MNSocketFactory.createServerSocketFactory(new TLAddress(11080), nbFactory1, new MNOptions(-1, -1 /*32*1024*/));
			rFactory2 = MNSocketFactory.createClientSocketFactory(new TLAddress("localhost", 11080), nbFactory2, new MNOptions(-1, -1 /*32*1024*/));
...
//			rFactory2 = nbFactory2;
		...
		brainOne.MAX_AGENT_DATA_TO_SEND_PER_ROUND = 1 * 2048;
		brainOne.TEST_TIME = 1 * 10 * 1000;
		brainOne.SLEEP_RAND_BETWEEN_ROUNDS = 100;
		brainOne.PRE_AND_POST_TEST_PROCESS_WAIT_TIME = 10 * 1000;
		...
		brainTwo.INITIAL_TEST_AGENTS = 2;
		brainTwo.MAX_AGENT_DATA_TO_SEND_PER_ROUND = 1 * 2048;
		brainTwo.TEST_TIME = 1 * 10 * 1000;
		brainTwo.SLEEP_RAND_BETWEEN_ROUNDS = 100;
		brainTwo.PRE_AND_POST_TEST_PROCESS_WAIT_TIME = 10 * 1000;
		...
		brainTwo.CONN_TO_NEW_PORT_PERCENT = 0.2;
