...
public class MultiSendReceiveMainMNNB {
...
//			rFactory2 = MNSocketFactory.createClientSocketFactory(new TLAddress("localhost", 11080), new TCPSocketFactory());
			...
			rFactory1 = MNSocketFactory.createServerSocketFactory(new TLAddress(11080), nbFactory1, new MNOptions(-1, 32*1024));
			rFactory2 = MNSocketFactory.createClientSocketFactory(new TLAddress("localhost", 11080), nbFactory2, new MNOptions(-1, 32*1024));
...
//			rFactory2 = nbFactory2;
		...
		brainOne.MAX_AGENT_DATA_TO_SEND_PER_ROUND = 12 * 2048;
		brainOne.TEST_TIME = 1 * 60 * 1000;
		...
		brainTwo.MAX_AGENT_DATA_TO_SEND_PER_ROUND = 12 * 2048;
		brainTwo.TEST_TIME = 1 * 60 * 1000;
